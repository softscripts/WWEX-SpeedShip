<?php
/**
 * File for class MynewServiceServiceVoid
 ...
 */
/**
 * This class stands for MynewServiceServiceVoid originally named Void

 * @author Soft Scripts Team <srinivas@softscripts.net>
 * @version 20140325-01
 * @date 2014-03-29
 */
class MynewServiceServiceVoid extends MynewServiceWsdlClass
{
    /**
     ...
     * @param MynewServiceStructVoidUPSShipment $_mynewServiceStructVoidUPSShipment
     * @return MynewServiceStructVoidUPSShipmentResponse
     */
    public function voidUPSShipment(MynewServiceStructVoidUPSShipment $_mynewServiceStructVoidUPSShipment)
    {
        try
        {
            return $this->setResult(self::getSoapClient()->voidUPSShipment($_mynewServiceStructVoidUPSShipment));
        }
